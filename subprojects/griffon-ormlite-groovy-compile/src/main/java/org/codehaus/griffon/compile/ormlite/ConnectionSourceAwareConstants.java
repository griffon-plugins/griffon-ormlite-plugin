...
public interface ConnectionSourceAwareConstants extends BaseConstants {
    ...
    MethodDescriptor[] METHODS = new MethodDescriptor[]{
        ...
        annotatedMethod(
            ...
            args(annotatedType(annotations(JAVAX_ANNOTATION_NONNULL), CONNECTION_SOURCE_CALLBACK_TYPE, R)),
        ...
        annotatedMethod(
            ...
            args(
                ...
                annotatedType(annotations(JAVAX_ANNOTATION_NONNULL), CONNECTION_SOURCE_CALLBACK_TYPE, R)),
            throwing(type(RUNTIME_SQL_EXCEPTION_TYPE))
        )
    };
}
